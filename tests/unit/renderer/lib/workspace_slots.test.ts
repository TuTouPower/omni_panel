...
const LOC_A = { source: "claude_code", env: "linux", session_id: "a" } as const;
const LOC_B = { source: "opencode", env: "linux", session_id: "b" } as const;
const LOC_C = { source: "grok", env: "linux", session_id: "c" } as const;
