        ...
        rows: [
            {
                ...
                account_key: "cpa-1|label|Claude Account",
                status: "ok" as const,
                is_hidden: false,
                is_removed: false,
            },
            {
                ...
                account_key: "cpa-1|label|Codex Account",
                status: "ok" as const,
                is_hidden: true,
                is_removed: false,
            },
            {
                ...
                account_key: "cpa-1|label|Old GLM",
                status: "ok" as const,
                is_hidden: false,
                is_removed: true,
            },
            ...
            rows: [
                {
                    ...
                    account_key: "cpa-1|label|Claude A",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
                {
                    ...
                    account_key: "cpa-1|label|Claude B",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
                {
                    ...
                    account_key: "cpa-1|label|Codex A",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
            ...
            rows: [
                {
                    ...
                    account_key: "cpa-1|label|user@example.com",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
            ...
            rows: [
                {
                    ...
                    account_key: "cpa-1|label|alice@example.com",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
                ...
                },
                {
                    ...
                    account_key: "cpa-1|label|bob@example.com",
                    status: "ok",
                    is_hidden: false,
                    is_removed: false,
                },
