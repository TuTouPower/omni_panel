...
- 现象：真实 codex rollout 文件修复 t448 去重后，入库会话 tokens 仍达 392M（omni_game gpt-5.6-sol 会话），而非该文件真实累计 196M。model 切换边界把已累计总量整段再计一次。
...
- 线索：真实文件 `/home/karon/.codex/sessions/2026/09/03/rollout-2026-09-03T08-55-52-*.jsonl`（948 事件 2 次 model 切换）；库值 392M vs 理论 196M。
- 处理：未开
