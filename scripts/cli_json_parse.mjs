 ...
 * 字段契约单一来源见 ./cli_json_parse.d.mts（CliInstanceInfo）。
 * @param {unknown} path
 * @returns {{ ok: true, info: import("./cli_json_parse.d.mts").CliInstanceInfo } | { ok: false, error: string }}
 */
export function parse_cli_json(path) {
    ...
    /** @type {import("./cli_json_parse.d.mts").CliInstanceInfo} */
    const validated = {
        port: info["port"],
        url: info["url"],
        pid: info["pid"],
